        ...
        <div className="flex flex-wrap -mx-4 items-center">
          <div className="w-full lg:w-1/2 px-4 mb-12 lg:mb-0 animate-fade-in-left">
            ...
            <div className="flex flex-wrap items-center">
              <a href="#services" className="bg-primary text-white px-6 py-3 rounded-full font-semibold mr-6 mb-4 md:mb-0 hover:bg-primary-dark transition duration-300">Explore Our Services</a>
