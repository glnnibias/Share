...
const FAQ = () => {
  ...
  return (
    <section id="faq" className="py-20 bg-gradient-to-b from-emerald-900 to-emerald-800">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12 animate-fade-in-up">
          <h4 className="text-emerald-300 font-semibold mb-2 uppercase tracking-wide">FAQs</h4>
