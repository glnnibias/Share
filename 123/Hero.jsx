...
const Hero = () => {
  ...
  return (
    <div id="home" className="relative bg-gray-900 text-white h-screen flex items-center overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-3xl">
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-3 leading-tight animate-fade-in-down">
          ...
          <div className="flex flex-col sm:flex-row justify-start items-start space-y-3 sm:space-y-0 sm:space-x-3 animate-fade-in-up animation-delay-300">
            <a
              href="#contact"
              className="bg-white text-primary px-5 py-2 rounded-md font-semibold text-sm hover:bg-primary hover:text-white transition duration-300 shadow-md hover:shadow-lg"
            >
              Explore Now
            </a>
          </div>
